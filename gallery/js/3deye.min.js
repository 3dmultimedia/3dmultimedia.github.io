(function(e) {
    ...
    e.vc3dEye = function(t, n) {
        ...
        h(t, n);
        m();
        e(u).html("<div style='background-image:url(images/swiper.gif);background-repeat: no-repeat;opacity:0.2; background-position: center bottom;'><div id='VCc' style='height:100%;width:100%;' class='onLoadingDiv'>Loading...</div>");
        v();
        p()
    }
})(jQuery)