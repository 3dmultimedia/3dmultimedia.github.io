(function(e) {
    ...
    e.vc3dEye = function(t, n) {
        ...
        h(t, n);
        m();
        e(u).html("<div style='background-image:url(images/scroll-down.gif);background-repeat: no-repeat;background-position: center bottom; opacity:0.2;'><div id='VCc' style='height:100%;width:100%;' class='onLoadingDiv'>Loading...</div>");
        v();
        p()
    }
})(jQuery)